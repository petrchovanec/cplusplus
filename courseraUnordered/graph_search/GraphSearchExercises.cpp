...
int GridGraph::countEdges() const {
  ...
  //(adjacencyMap.size() + NeighborSet.size())/2;

  // =======================================================================
  // TODO: Your code here!
  // =======================================================================
  for (auto const& kk :  adjacencyMap){
    for (auto const& kk2 :  kk.second){
      numEdges++;
...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  // =======================================================================
    ...
    for (auto const& kk :  originalNeighbors){
      adjacencyMap.at(kk).erase(p1);
    }
